...
class trialObject {
    ...
    run() {
        ...
        this.thisTrial = this.trialList.pop(0);
        this.thisTrial.keywords = shuffle(this.thisTrial.keywords);
    ...
    // trial.saverating(SHUFFLED_CATEGORY[TRIAL_NUM], SHUFFLED_INDEX[TRIAL_NUM], rating, likability, prototypicality, TRIAL_NUM);
    saverating(category, index, rating, likability, prototypicality, trialnum, view) {
        // reaction time
        this.rt = (this.respondTime - this.startTime)/1000;
        ...
        // rating
        if (likability){
            this.ratingLike = rating;
        }
        else if (prototypicality) {
            this.ratingTypical = rating;
        }
